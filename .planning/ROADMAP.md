...
**Spec**: SPEC_v2.md §5.5
**Plans:** 6 plans — `.planning/phases/24-identidad-temporal-votaci-n-y-m-quina-de-estados/`

Plans:
- [ ] 24-01-PLAN.md — TemporalVoter + IdentityState y los 5 parámetros de configuración (wave 1)
- [ ] 24-02-PLAN.md — IdentityStateMachine: 4 estados, revalidación, herencia de identidad y gate de FACE-11 (wave 2)
