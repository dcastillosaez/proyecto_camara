...
`CONFIG_CHANGED`) completo. Quedan `27-08`..`27-11` (overlay MJPEG,
...
| 27 — Multi-clase y contexto de escena | B | ⧗ En progreso (7/11 planes) | — | 4 planes restantes (27-08..27-11) |
...
Suite completa: **508/508 passing** (última ejecución 2026-08-17, tras `27-07`: +8 tests
...
Stopped at: Ejecutado 27-07-PLAN.md (wave 4, depende de 27-02+27-04+27-06). Router
...
Resume file: ninguno registrado todavía para `27-08` — generar/ejecutar con
  `/gsd:execute-phase 27`.
