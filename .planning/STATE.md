...
`CONFIG_CHANGED`) y `27-08` (`StreamingWorker` dibuja objetos trackeados
en magenta sobre el feed MJPEG via un `Callable` inyectado, `manager.py`
cablea `self.get_object_boxes`) completos. Quedan `27-09`..`27-11`
...
| 27 — Multi-clase y contexto de escena | B | ⧗ En progreso (8/11 planes) | — | 3 planes restantes (27-09..27-11) |
...
Suite completa: **512/512 passing** (última ejecución 2026-08-17, tras `27-08`: +4 tests
