...
`hourly_baseline()`, `known` solo `identity_state is CONFIRMED`) completos.
Quedan `27-10`..`27-11` (control de clases en el dashboard y puerta de fase
...
| 27 — Multi-clase y contexto de escena | B | ⧗ En progreso (9/11 planes) | — | 2 planes restantes (27-10..27-11) |
